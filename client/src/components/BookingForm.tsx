...
export default function BookingForm({ isQuickBooking = false }: BookingFormProps = {}) {
  ...
  const selectSuggestion = (inputId: string, suggestion: AddressSuggestion) => {
    // For POIs, use the address (secondary_text) as the value for the actual address field
  ...
  return (
    <div className="backdrop-blur-sm rounded-2xl shadow-2xl bg-background w-full max-w-full p-4 sm:p-6 lg:p-8 pl-[10px] pr-[10px] pt-[10px] pb-[10px]">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            {showSuggestions.from && suggestions.from?.length > 0 && (
              <div className="absolute top-full left-0 right-0 bg-background border border-border border-t-0 rounded-b-lg max-h-72 overflow-y-auto z-50 shadow-lg">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-2">
                ...
                <Select value={period} onValueChange={(value) => setPeriod(value as 'AM' | 'PM')}>
                  <SelectTrigger className="p-3 border-2 border-border rounded-lg text-[12px]" data-testid="select-period">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-[2fr_3fr] gap-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-2">
                <Select value={hour} onValueChange={setHour}>
                  <SelectTrigger className="p-3 border-2 border-border rounded-lg text-[12px]" data-testid="select-hour">
                    <SelectValue placeholder={t('booking.placeholders.hour')} />
                  </SelectTrigger>
                  <SelectContent>
                    {Array.from({ length: 12 }, (_, i) => i + 1).map((h) => (
